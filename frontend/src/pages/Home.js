...
function Home() {
  ...
  const [ddos, setDdos] = useState(66);
  const [adb, setAdb] = useState(25);
              ...
              <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
                <div className="grid md:grid-cols-3 sm:grid-cols-1 justify-items-center">
                  ...
                  >
                    ...
                    <div class="mt-4 ">
                      <p class="text-gray-900"> 42.00%(Static)</p>
                      <div class="bg-gray-400 w-64 h-3 rounded-lg mt-2 overflow-hidden">
                        <div class="bg-white w-1/3 h-full rounded-lg shadow-md"></div>
                      </div>
                    </div>
                  </div>
                  <div
                ...
                <Flickity
                  className={"carousel d-lg-none d-xl-none mt-5"} // default ''
                ...
                >
                  <div class="bg-yellow-500 p-10 rounded-lg shadow-md mx-5">
                    <div class="flex justify-between items-center">
                      ...
                      <button class="flex items-center justify-center text-xl font-medium rounded-full px-4 py-1 space-x-1 border-1 border-black bg-white hover:bg-black hover:text-white text-black dark:bg-slate-800 dark:text-white dark:border-white dark:hover:bg-white dark:hover:text-black">
                        <RiDeleteBin5Fill />
                      </button>
                    </div>
                  ...
                  <div class="bg-yellow-500 p-10 rounded-lg shadow-md mx-5">
                    ...
                    <div class="mt-4 mb-10">
                      <p class="text-gray-900">{"Attacks: " + adb + "%"}</p>
                      <div class="bg-gray-400 w-64 h-3 rounded-lg mt-2 overflow-hidden">
                  ...
                  <div
                    class={
                      "bg-yellow-500 p-10 rounded-lg shadow-md mx-5 " + hidden
                    }
                  >
                    <div class="flex justify-between items-center">
                      <h1 class="text-xl font-bold">Deliah</h1>
                      <button
                        class="flex items-center justify-center text-xl font-medium rounded-full px-4 py-1 space-x-1 border-1 border-black bg-white hover:bg-black hover:text-white text-black dark:bg-slate-800 dark:text-white dark:border-white dark:hover:bg-white dark:hover:text-black"
                        onClick={delelteCard}
                      >
                        <RiDeleteBin5Fill />
                      </button>
